  ...
  return (
    <footer className="relative overflow-hidden border-t border-[#1d2b31] bg-[#081417] text-[#f7efe5]">
      ...
      <div className="relative mx-auto flex w-full max-w-7xl flex-col gap-8 px-4 py-8 sm:px-6 lg:px-8">
        <section className="flex flex-col gap-6 rounded-[28px] border border-white/10 bg-white/[0.045] px-4 py-5 shadow-[0_22px_60px_-40px_rgba(0,0,0,0.55)] backdrop-blur-sm sm:px-5 sm:py-6 lg:flex-row lg:items-center lg:justify-between">
          <div className="max-w-2xl">
            ...
            <p className="mt-3 max-w-xl text-sm leading-6 text-[#d7c8bc]">
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              {marketChips.map((chip) => (
                <span
                  key={chip}
                  className="rounded-full border border-white/10 bg-white/5 px-3 py-1 text-[11px] font-semibold text-[#f7efe5]/90"
                >
                  {chip}
                </span>
              ))}
          ...
          <div className="flex flex-col gap-3 sm:flex-row">
            <Link
              ...
              className="inline-flex items-center justify-center gap-2 rounded-full bg-[#eb6239] px-4 py-2.5 text-sm font-bold text-white transition-all duration-300 hover:-translate-y-0.5 hover:bg-[#f07650] hover:shadow-[0_18px_40px_-20px_rgba(235,98,57,0.6)]"
            >
            ...
            <Link
              href="/list-property"
              className="inline-flex items-center justify-center gap-2 rounded-full border border-white/15 bg-white/5 px-4 py-2.5 text-sm font-bold text-white transition-all duration-300 hover:-translate-y-0.5 hover:border-[#f3c7b7]/70 hover:bg-white/10"
            >
        ...
        <section className="grid gap-6 lg:grid-cols-[1.2fr,0.8fr]">
                ...
                <ul className="mt-3 space-y-2.5">
                  {section.links.map((link) => (
                    <li key={link.href}>
                      <Link
                        href={link.href}
                        className="inline-flex items-center gap-2 text-sm text-[#d7c8bc] transition-all duration-300 hover:translate-x-1 hover:text-white"
                      >
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            <a
              ...
              className="flex items-center gap-3 rounded-[18px] border border-white/10 bg-white/5 px-4 py-3 text-sm text-[#f7efe5] transition-all duration-300 hover:-translate-y-0.5 hover:border-[#f3c7b7]/60 hover:bg-white/10"
            >
        ...
        <section className="flex flex-col gap-3 border-t border-white/10 pt-4 text-sm text-[#bfae9f] sm:flex-row sm:items-center sm:justify-between">
